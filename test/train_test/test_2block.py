...
from src.model.cnn_model import DwtConvNet2Class2Block
...
if __name__ == '__main__':
    with open('../parameter.yml', 'r') as parameter_yml: 
        ...
        dwt_cnn = DwtConvNet2Class2Block().to(device)
        ...
        dwt_train = DwtConvTrain(dwt_cnn,dataloader,criterion,optimizer_ft,epochs=200)
