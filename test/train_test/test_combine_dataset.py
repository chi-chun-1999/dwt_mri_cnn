...
from src.data.load_data.load_data import MRIDatasetResizeMedianCombine
...
if __name__ == '__main__':
    with open('../parameter.yml', 'r') as parameter_yml: 
        ...
        test_dataset = MRIDatasetResizeMedianCombine(test_data_dict,dwt_times=dwt_times)
        
        train_data_dict = data['Dataset_path_train']
        train_dataset = MRIDatasetResizeMedianCombine(train_data_dict,dwt_times=dwt_times)
        ...
        #tmp_dataloader = {'train':DataLoader(train_dataset,batch_size=10,shuffle=True),'val':DataLoader(test_dataset,batch_size=10,shuffle=True)}
